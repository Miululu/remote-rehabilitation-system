...
# 配置七牛云信息
access_key ="BEhg-NjUApaHbz5xli_c20zzlg7EgL9KPX8g6rvs"
secret_key = "8POf-eJGpmKW1ljXOypL9U7UEQyddkUlCOhHqBIL"
bucket_name = "miululu"
bucket_url = "rhd6x75bo.hn-bkt.clouddn.com"
...
# # 需要上传到七牛云的图片路径
# image_up_path = "pudding2.jpg"
# # 上传到七牛云后，保存成的图片名称
# image_qiniu_name = "pudding2.jpg"
...
def upload_images(image_name, image_path):
    # 将图片上传到七牛云，并保存成image_qiniu_name的名称
